...
try:
    # --- Component Metadata ---
    ghenv.Component.Name = "GridVoronoi"
    ghenv.Component.NickName = "VorGrid"
    ...
    if ghenv.Component.Params.Input.Count > 0:
        ...
        ghenv.Component.Params.Input[0].Description = "List of Geometry (Surfaces, Breps, or Closed Curves)"

    # Index 1: boundary
    if ghenv.Component.Params.Input.Count > 1:
        ghenv.Component.Params.Input[1].Name = "boundary"
        ghenv.Component.Params.Input[1].NickName = "Bnd"
        ghenv.Component.Params.Input[1].Description = "Curve (A single boundary curve to clip the entire Voronoi pattern)"

    # Index 2: min_eval
    if ghenv.Component.Params.Input.Count > 2:
        ghenv.Component.Params.Input[2].Name = "min_eval"
        ghenv.Component.Params.Input[2].NickName = "MinEv"
        ghenv.Component.Params.Input[2].Description = "Float (Minimum value to evaluate reparameterized surface, between 0 and 1)"

    # Index 3: max_eval
    if ghenv.Component.Params.Input.Count > 3:
        ghenv.Component.Params.Input[3].Name = "max_eval"
        ghenv.Component.Params.Input[3].NickName = "MaxEv"
        ghenv.Component.Params.Input[3].Description = "Float (Maximum value to evaluate reparameterized surface, between 0 and 1)"
    ...
    if ghenv.Component.Params.Input.Count > 4:
        ...
        ghenv.Component.Params.Input[4].Description = "Integer (Seed for random value generation)"

    # --- Outputs Metadata ---
    # Index 0: voronoi_cells
    if ghenv.Component.Params.Output.Count > 0:
        ghenv.Component.Params.Output[0].Name = "voronoi_cells"
        ghenv.Component.Params.Output[0].NickName = "Cells"
        ghenv.Component.Params.Output[0].Description = "List of Curves (The generated Voronoi cells based on the evaluated points)"

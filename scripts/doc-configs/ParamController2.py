...
2. Create three inputs on the component:
   - `Update` (Type hint: bool)
   - `CSV_File` (Type hint: str)
   - `Section` (Type hint: str) [Optional]
...
6. (Optional) Wire a Panel with the desired section name to `Section`.

The CSV must have columns: `input name`, `type`, `value`, `section`
"""
...
def main():
    ...
    with open(CSV_File, mode='r') as f:
        ...
        try:
            ...
            # Fallback to column 3 if it exists, otherwise -1 (no section column)

...
RHINO_PLUG_IN_NAME(L"SampleRdkMaterialPreview");

// Rhino plug-in id
// Provide a unique uuid for this plug-in.
RHINO_PLUG_IN_ID(L"E620ED01-3284-47F1-BB10-B15CF062F1E4");
...
RHINO_PLUG_IN_DESCRIPTION(L"SampleRdkMaterialPreview plug-in for Rhinoceros®");
...
// The one and only CSampleRdkMaterialPreviewPlugIn object
static class CSampleRdkMaterialPreviewPlugIn thePlugIn;

CSampleRdkMaterialPreviewPlugIn& SampleRdkMaterialPreviewPlugIn()
{
  // Return a reference to the one and only CSampleRdkMaterialPreviewPlugIn object
  return thePlugIn;
}

CSampleRdkMaterialPreviewPlugIn::CSampleRdkMaterialPreviewPlugIn()
{
  // Description:
  //   CSampleRdkMaterialPreviewPlugIn constructor. The constructor is called when the
  //   plug-in is loaded and "thePlugIn" is constructed. Once the plug-in
  //   is loaded, CSampleRdkMaterialPreviewPlugIn::OnLoadPlugIn() is called. The
  //   constructor should be simple and solid. Do anything that might fail in
  //   CSampleRdkMaterialPreviewPlugIn::OnLoadPlugIn().
...
const wchar_t* CSampleRdkMaterialPreviewPlugIn::PlugInName() const
{
  // Description:
...
const wchar_t* CSampleRdkMaterialPreviewPlugIn::PlugInVersion() const
{
  // Description:
...
GUID CSampleRdkMaterialPreviewPlugIn::PlugInID() const
{
  // Description:
...
BOOL CSampleRdkMaterialPreviewPlugIn::OnLoadPlugIn()
{
  // Description:
  ...
  m_pRdkPlugIn = new CSampleRdkMaterialPreviewRdkPlugIn;
  ON_wString str;
...
void CSampleRdkMaterialPreviewPlugIn::OnUnloadPlugIn()
{
  // Description:
...
CRhinoCommand::result CSampleRdkMaterialPreviewPlugIn::Render(const CRhinoCommandContext& context, bool bPreview)
{
	return CRhinoCommand::failure; 
}

CRhinoCommand::result CSampleRdkMaterialPreviewPlugIn::RenderWindow(const CRhinoCommandContext& context, bool render_preview,
...
CRhinoCommand::result CSampleRdkMaterialPreviewPlugIn::RenderQuiet(const CRhinoCommandContext& context, bool bPreview)
{
  UNREFERENCED_PARAMETER(context);
...
BOOL CSampleRdkMaterialPreviewPlugIn::SaveRenderedImage(ON_wString filename)
{
  // Description:
...
BOOL CSampleRdkMaterialPreviewPlugIn::CloseRenderWindow()
{
  // Description:
...
UINT CSampleRdkMaterialPreviewPlugIn::MainFrameResourceID() const
{
  return IDR_RENDER;
}

...
{
public:
	// CSampleRdkRendererPlugIn constructor. The constructor is called when the
	// plug-in is loaded and "thePlugIn" is constructed. Once the plug-in
	// is loaded, CSampleRdkRendererPlugIn::OnLoadPlugIn() is called. The
	// constructor should be simple and solid. Do anything that might fail in
	// CSampleRdkRendererPlugIn::OnLoadPlugIn().
	CSampleRdkRendererPlugIn();

	// CSampleRdkRendererPlugIn destructor. The destructor is called to destroy
	// "thePlugIn" when the plug-in is unloaded. Immediately before the
	// DLL is unloaded, CSampleRdkRendererPlugIn::OnUnloadPlugin() is called. Do
...
private:
	...
	CSampleRdkRendererEventWatcher m_event_watcher;
	class CSampleRdkRendererRdkPlugIn* m_pRdkPlugIn;

	// TODO: Add additional class information here
};

// Return a reference to the one and only CSampleRdkRendererPlugIn object

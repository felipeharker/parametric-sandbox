...
try:
    ...
    if ghenv.Component.Params.Input.Count > 0:
        ...
        ghenv.Component.Params.Input[0].Description = "List of Curves (Base grid cells to reference as boundaries)"

    # Index 1: inner_scale
    if ghenv.Component.Params.Input.Count > 1:
        ghenv.Component.Params.Input[1].Name = "inner_scale"
        ghenv.Component.Params.Input[1].NickName = "Scl"
        ghenv.Component.Params.Input[1].Description = "Float (Scale factor between 0.0 and 1.0 for the inner cell)"

    # Index 2: eval_outer
    if ghenv.Component.Params.Input.Count > 2:
        ghenv.Component.Params.Input[2].Name = "eval_outer"
        ghenv.Component.Params.Input[2].NickName = "EvO"
        ghenv.Component.Params.Input[2].Description = "Float (Evaluation parameter between 0.0 and 1.0 for outer cell edges)"

    # Index 3: eval_inner
    if ghenv.Component.Params.Input.Count > 3:
        ghenv.Component.Params.Input[3].Name = "eval_inner"
        ghenv.Component.Params.Input[3].NickName = "EvI"
        ghenv.Component.Params.Input[3].Description = "Float (Evaluation parameter between 0.0 and 1.0 for inner cell edges)"

    # Index 4: point_toggle
    if ghenv.Component.Params.Input.Count > 4:
        ghenv.Component.Params.Input[4].Name = "point_toggle"
        ghenv.Component.Params.Input[4].NickName = "PTog"
        ghenv.Component.Params.Input[4].Description = "List of Booleans (7-item list of 0s and 1s activating specific generator points)"

    # --- Outputs Metadata ---
    # Index 0: pattern_curves
    if ghenv.Component.Params.Output.Count > 0:
        ghenv.Component.Params.Output[0].Name = "pattern_curves"
        ghenv.Component.Params.Output[0].NickName = "Crvs"
        ghenv.Component.Params.Output[0].Description = "DataTree of Curves (The final generated Voronoi pattern curves, organized by grid cell)"
